...
class Emprestimo
{
    ...
    public function adicionarEmprestimo($cliente_id, $valor_total, $taxa_juros, $quantidade_parcelas, $data_inicio, $dia_vencimento, $tipo_juros, $frequencia_juros)
    {
        ...
        $stmt->bindValue(':dia_vencimento', $dia_vencimento, PDO::PARAM_STR);
        ...
        for ($i = 1; $i <= $quantidade_parcelas; $i++) {
            $data_vencimento = date('Y-m-d', strtotime("+$i month", strtotime($dia_vencimento)));
    ...
    public function atualizarEmprestimo($id, $valor_total, $taxa_juros, $quantidade_parcelas, $data_inicio, $dia_vencimento, $tipo_juros, $frequencia_juros)
    {
        ...
        $stmt->bindValue(':dia_vencimento', $dia_vencimento);
        ...
        if ($resultado) {
            $this->atualizarParcelas($id, $quantidade_parcelas, $valor_total, $taxa_juros, $data_inicio, $dia_vencimento, $tipo_juros, $frequencia_juros);
        }
     ...
     * @param string $frequencia_juros Frequência dos juros (mensal ou anual)
     */
    public function atualizarParcelas($emprestimo_id, $quantidade_parcelas, $valor_total, $taxa_juros, $data_inicio, $dia_vencimento, $tipo_juros, $frequencia_juros)
    {
